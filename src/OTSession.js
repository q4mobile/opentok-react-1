...
export default class OTSession extends Component {
    ...
    createSession() {
        ...
        if (
            ...
            const { onSessionHelperCreated } = this.props.eventHandlers;

            if (
                onSessionHelperCreated &&
                typeof onSessionHelperCreated == "function"
            ) {
                this.props.eventHandlers.onSessionHelperCreated(
                    this.sessionHelper
                );
            }
        }
